...
function makeAlbum(artist: string, title: string, num?: number) {
    const musicAlbum : {artist: string, title: string, num?: number } = {
...
let album2 = makeAlbum("Artist2", "Album2", 2);
console.log(album2);

let album3 = makeAlbum("Artist3", "Album3", 3);
console.log(album3)
